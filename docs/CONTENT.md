...
Solo existe un cron programado: se dispara a las 09:00 UTC y procesa primero el slot `1` y después el slot `2`. En Chile continental se ejecutará a las 05:00 mientras rija UTC-4 y a las 06:00 mientras rija UTC-3; Vercel no cambia la expresión UTC cuando cambia el horario local.
